  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved folder as @folder" do
        ...
        post :create, {:folder => { "category_id" => "invalid value" }}, valid_session
        assigns(:folder).should be_a_new(Folder)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested folder" do
        ...
        Folder.any_instance.should_receive(:update_attributes).with({ "category_id" => "1" })
        put :update, {:id => folder.to_param, :folder => { "category_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the folder as @folder" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Folder.any_instance.stub(:save).and_return(false)
        put :update, {:id => folder.to_param, :folder => { "category_id" => "invalid value" }}, valid_session
        assigns(:folder).should eq(folder)
      end
