  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved upload_file as @upload_file" do
        ...
        post :create, {:upload_file => { "folder_id" => "invalid value" }}, valid_session
        assigns(:upload_file).should be_a_new(UploadFile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested upload_file" do
        ...
        UploadFile.any_instance.should_receive(:update_attributes).with({ "folder_id" => "1" })
        put :update, {:id => upload_file.to_param, :upload_file => { "folder_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the upload_file as @upload_file" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UploadFile.any_instance.stub(:save).and_return(false)
        put :update, {:id => upload_file.to_param, :upload_file => { "folder_id" => "invalid value" }}, valid_session
        assigns(:upload_file).should eq(upload_file)
      end
