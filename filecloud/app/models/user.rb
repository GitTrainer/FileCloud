class User < ActiveRecord::Base
  ...
  attr_accessible :name, :email, :password, :password_confirmation, :password_required,:avatar_file_name,:avatar_content_type, :avatar_file_size,:avatar_updated_at,:pic
